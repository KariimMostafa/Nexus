...
sr.reveal(".preview");
sr.reveal(".testimonyPreview", { delay: 400 });
...
//About Section
sr.reveal(".about .gradient-light-blue");
...
sr.reveal(".gradient-light-blue", { delay: 800 });
